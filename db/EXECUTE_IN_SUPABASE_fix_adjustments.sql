-- ========================================================================
-- FIX CRÍTICO MANUAL: Solo ajustes APPROVED deben afectar cálculo
-- ========================================================================
-- EJECUTAR EN SUPABASE SQL EDITOR:
-- Dashboard → SQL Editor → New query → Pegar este contenido → Run
-- ========================================================================
-- Filosofía: "Los cálculos deben ser siempre sobre los movimientos reales.
--            La contribución no está realizada hasta que no existen los movimientos."
-- ========================================================================
...
BEGIN
  ...
  -- Ajustes pending son "propuestas" y NO deben afectar el cálculo
  -- Solo cuando se aprueban (y se crean los movimientos) deben contar
...
-- Forzar recalculo de todas las contribuciones existentes con ajustes
-- Esto ejecutará el trigger actualizado para cada contribución
...
-- ========================================================================
-- DESPUÉS DE EJECUTAR:
-- 1. Verificar en UI que ajuste pending NO afecta "Total esperado"
-- 2. Aprobar el ajuste pending
-- 3. Verificar que AHORA SÍ afecta el cálculo
-- 4. Verificar que se crearon los 2 movimientos en /app/expenses
-- ========================================================================
