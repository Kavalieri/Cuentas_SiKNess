-- =========================================================================
-- SCRIPT: Corrección manual de transacciones específicas (Issue #16)
-- =========================================================================
-- Fecha: 2025-11-02
...
-- Variables para los IDs (sustituir según entorno)
\set cat_vivienda 'a98773a7-a0ae-49a0-84de-519ec4548c79'
\set cat_menaje '00cf0984-4823-468d-a2b6-0930aa14815d'
\set sub_alquiler 'b6ec254e-12fe-4a2f-beec-66ea21641677'
\set sub_comunidad '41e70074-346e-491b-ab7f-157f35859bfe'
