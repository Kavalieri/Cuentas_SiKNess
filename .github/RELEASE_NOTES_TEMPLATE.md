# 🚀 CuentasSiK v0.2.0-alpha

> **Primera versión alpha pública** - Sistema completo de gestión de gastos compartidos para parejas

---

## 🌐 Enlaces Importantes

- **🎯 Demo en Vivo**: https://cuentas-sik.vercel.app
...
**CuentasSiK** es una aplicación web minimalista para gestionar gastos compartidos entre parejas o compañeros de piso, con un enfoque en contribuciones proporcionales según los ingresos de cada miembro.

### ✨ Características Principales

- ✅ **Gestión de Gastos e Ingresos**: Registro completo de movimientos con categorías personalizables
...
- ✅ **Dashboard Interactivo**: Visualización con gráficos (Recharts) y resúmenes mensuales
- ✅ **Historial de Auditoría**: Edición de movimientos con registro automático de cambios
...
- ✅ **Pre-pagos con Aprobación**: Workflow para registrar gastos adelantados con aprobación del owner
- ✅ **Panel de Administración**: Gestión completa del hogar, miembros e invitaciones
- ✅ **Autenticación Segura**: Magic links por email sin contraseñas (Supabase Auth)
...
1. **Accede a la aplicación**: https://cuentas-sik.vercel.app
...
- **35+ Bug Fixes** resueltos
- **12 Tablas** en base de datos con RLS
- **100% Cobertura** Row Level Security
- **26 Páginas** compiladas
- **20+ Migraciones** SQL aplicadas
...
## ⚠️ Notas Importantes - Alpha Release

Esta es una **versión alpha** (0.2.0-alpha), lo que significa:

- ✅ Todas las características principales están implementadas y funcionan
- ⚠️ Puede haber bugs menores o edge cases no contemplados
- 🔄 La API y estructura de datos pueden cambiar (aunque intentaremos minimizar breaking changes)
- 📝 La documentación está en progreso continuo
- 🧪 No recomendado para datos críticos sin backups
